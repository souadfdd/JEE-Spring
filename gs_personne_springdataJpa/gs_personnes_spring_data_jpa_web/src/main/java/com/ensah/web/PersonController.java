...
public class PersonController {
	...
	@RequestMapping("/oldestMoroccanPersons")
	public String oldestMoroccanPersons(Model model) {

		model.addAttribute("personList", personService.getPersonsStateOrderdByAge("Morocco")); 

		return "oldestMoroccanPersons";
	}
