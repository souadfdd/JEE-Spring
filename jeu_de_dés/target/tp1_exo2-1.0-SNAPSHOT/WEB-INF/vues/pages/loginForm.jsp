...
<body>
<h1  class="m-5" style="color:green;text-align:center ;font-family: 'Noto Serif', serif;">Connexion</h1>
<div class="container " style="font-family: 'Noto Serif', serif;">
    <div class="row align-items-center justify-content-center align-items-center">
        <div class="col-6 con">
            <form  action="${pageContext.request.contextPath}/LoginServlet" method="POST" class="border border-2 rounded p-5 border-success ">
                ...
                <button type="submit" class="btn m-3" style="color:white; background-color: green;">Sign in</button>
            </form>
        </div>
    </div>
</div>
